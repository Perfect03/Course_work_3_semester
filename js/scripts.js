...
f[2][0][1] ="1111";
f[2][1][0] ="../img/functions/2/2.jpg"; // 2 переменные
f[2][1][1] ="0010";
f[2][2][0] ='../img/functions/2/3.jpg'; // 2 переменные
f[2][2][1] ="1111";
f[2][3][0] ="../img/functions/2/4.jpg"; // 2 переменные
f[2][3][1] ="0011";
f[2][4][0] ='../img/functions/2/5.jpg'; // 2 переменные
f[2][4][1] ="1001";
f[2][5][0] ="../img/functions/2/6.jpg"; // 2 переменные
f[2][5][1] ="1001";


f[3][0][0] ='../img/functions/3/1.jpg'; // 3 переменные
f[3][0][1] ="11111010";
f[3][1][0] ='../img/functions/3/2.jpg'; // 3 переменные
f[3][1][1] ="00101111";

f[3][2][0] ='../img/functions/3/3.jpg'; // 3 переменные
f[3][2][1] ="11111111";
f[3][3][0] ="../img/functions/3/4.jpg"; // 3 переменные
f[3][3][1] ="00000010";
f[3][4][0] ='../img/functions/3/5.jpg'; // 3 переменные
f[3][4][1] ="00111110";
f[3][5][0] ="../img/functions/3/6.jpg"; // 3 переменные
f[3][5][1] ="00101010";

f[4][0][0] ='../img/functions/4/1.jpg'; // 4 переменные
f[4][0][1] ="0000100011000000";
f[4][1][0] ='../img/functions/4/2.jpg'; // 4 переменные
f[4][1][1] ="1111111111111111";

f[4][2][0] ='../img/functions/4/3.jpg'; // 4 переменные
f[4][2][1] ="1100111011011101";
f[4][3][0] ="../img/functions/4/4.jpg"; // 4 переменные
f[4][3][1] ="0000111111111111";
f[4][4][0] ='../img/functions/4/5.jpg'; // 4 переменные
f[4][4][1] ="0000000011001100";
f[4][5][0] ="../img/functions/4/6.jpg"; // 4 переменные
f[4][5][1] ="0000111011101111";

f[5][0][0] ='../img/functions/5/1.jpg'; // 5 переменных
f[5][0][1] ="00100100001011000000010000100100";
f[5][1][0] ='../img/functions/5/2.jpg'; // 5 переменных
f[5][1][1] ="10011001100111011001100110011001";

f[5][2][0] ='../img/functions/5/3.jpg'; // 5 переменных
f[5][2][1] ="00100011000000110000001100000011";
f[5][3][0] ="../img/functions/5/4.jpg"; // 5 переменных
f[5][3][1] ="00000110000001110000011000000110";
f[5][4][0] ='../img/functions/5/5.jpg'; // 5 переменных
f[5][4][1] ="00000000000000000000000000000000";
f[5][5][0] ="../img/functions/5/6.jpg"; // 5 переменных
